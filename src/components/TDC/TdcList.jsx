...
const SECTIONS = [
  {
    items: [
      ...
      {
        name: "Engineering Deviation Request/Note",
        icon: ClipboardMinus,
        path: "/engineeringdeviationrequest",
        screenCode: "ENGINEERING_DEVIATION_REQUEST",
      },
      {
        name: "Supplier Change Request (SCR)",
        icon: ClipboardCheck,
        path: "/supplierchangerequest",
        screenCode: "SUPPLIER_CHANGE_REQUEST",
      },
      {
        name: "Inspection Requisition Note",
        icon: ClipboardList,
        path: "/inspectionrequisitionnote",
        screenCode: "INSPECTION_REQUISITION_NOTE",
      },
    ],
  },
];
      ...
      {hasAnyItems ? (
        <>
          ...
          <div className="flex items-center gap-2 mb-4">
            <div className="p-1.5 rounded-lg bg-gradient-to-br from-cyan-600 to-blue-600 shadow-sm">
            ...
            <span className="text-xs text-gray-500 dark:text-gray-400 ml-2">
              Manage engineering change control, deviation requests and
