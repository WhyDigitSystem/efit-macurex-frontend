    ...
    items: [
      {
        ...
        screenCode: "PRODUCTION_SCHEDULE_ORDER",
      },
      {
        name: "Material Indent For Production",
        icon: Package,
        path: "/materialindentproduction",
        screenCode: "MATERIAL_INDENT_FOR_PRODUCTION",
      },
      {
        name: "Production Entry",
        icon: Factory,
        path: "/productionentry",
        screenCode: "PRODUCTION_ENTRY",
      },
      {
        name: "Production Transfer Slip",
        icon: ArrowRightLeft,
        path: "/productiontransferslip",
        screenCode: "PRODUCTION_TRANSFER_SLIP",
      },
      {
        name: "FG Transfer Slip Entry",
        icon: PackageCheck,
        path: "/fgtransferslipentry",
        screenCode: "FG_TRANSFER_SLIP_ENTRY",
      },
      {
      ...
      },
      {
        ...
        screenCode: "MATERIAL_TRANSFER_RETURN_NOTE",
      },
      {
        name: "Scrap Note",
        icon: Trash2,
        path: "/scrapnote",
        screenCode: "SCRAP_NOTE",
      },
      {
        name: "Production Sch. Order ShortClosed",
        icon: ClipboardX,
        path: "/productionscheduleordershortclosed",
        screenCode: "PRODUCTION_SCHEDULE_ORDER_SHORT_CLOSED",
      },
      {
        name: "Stock Order",
        icon: ShoppingCart,
        path: "/stockorder",
        screenCode: "STOCK_ORDER",
      },
      {
        name: "Process Validation Entry",
        icon: ShieldCheck,
        path: "/processvalidationentry",
        screenCode: "PROCESS_VALIDATION_ENTRY",
      },
      {
        name: "Bulk Issue Indent",
        icon: PackagePlus,
        path: "/bulkissueindent",
        screenCode: "BULK_ISSUE_INDENT",
      },
      {
        name: "Reconcile Consumption Stock",
        icon: RefreshCcw,
      ...
      },
      {
        ...
        screenCode: "MACHINE_SETTING_PLAN",
      },
      {
        name: "Production Issues",
        icon: Wrench,
        path: "/productionissues",
        screenCode: "PRODUCTION_ISSUES",
      },
      {
        name: "Production (Bulk) Issues",
        icon: Boxes,
