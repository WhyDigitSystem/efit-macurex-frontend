...
const Header = () => {
  ...
  const loginFinYear = globalParam?.finYear || localStorage.getItem("finYear") || "";
...
{/* <div className="flex-1 mx-6">
  <div className="flex flex-wrap items-center gap-3">
    ...
    <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full 
                     ...
                     text-sm font-medium">
      <Building2 className="h-4 w-4" /> {loginBranch || "Branch"}
    </span>
   ...
   <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full 
                 ...
                 text-sm font-medium">
  <UserCog className="h-4 w-4" /> {loginCustomer || "Customer"}
</span>
...
<span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full 
                 ...
                 text-sm font-medium">
  <User className="h-4 w-4" /> {loginClient || "Client"}
</span>
    ...
    <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full 
                     ...
                     text-purple-700 dark:text-purple-300 
                     text-sm font-medium">
       <Calendar className="h-4 w-4" /> {loginFinYear}
    </span>
...
<div className="flex-1 mx-6">
  <div className="flex flex-wrap items-center gap-3">
    ...
    {/* Branch - Emerald color with silver outline */}
    ...
    {/* Customer - Amber color with silver outline */}
    <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full 
    ...
    {/* Client - Red color with silver outline */}
    {/* <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full 
    ...
    {/* Financial Year - Amber color with silver outline */}
    <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full 
                     bg-amber-50 dark:bg-amber-900/30 
                     text-amber-700 dark:text-amber-300 
                     border border-gray-300 dark:border-gray-600
