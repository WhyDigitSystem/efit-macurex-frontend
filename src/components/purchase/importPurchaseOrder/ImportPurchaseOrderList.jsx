...
const ImportPurchaseOrderList = ({
  ...
  const loadOrders = useCallback(async () => {
    try {
      ...
      console.error("Failed to load import purchase orders:", error);
      setOrderData([]);
      toast.error("Failed to fetch Import Purchase Orders");
    } finally {
      setLoading(false);
    }
  }, [ORG_ID]);
  ...
  return (
    <CommonListViewTable
      ...
      emptyMessage="No Import Purchase Orders found"
      loadingMessage="Loading Import Purchase Orders..."
      enableRefresh={true}
      onRefresh={loadOrders}
      enableExport={true}
      exportFileName="ImportPurchaseOrders"
    />
  );
};

export default ImportPurchaseOrderList;