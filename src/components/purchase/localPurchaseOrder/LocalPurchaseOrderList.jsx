...
const LocalPurchaseOrderList = ({
  ...
  const loadOrders = useCallback(async () => {
    try {
      ...
      console.error("Failed to load local purchase orders:", error);
      setOrderData([]);
  ...
  return (
    <CommonListViewTable
      ...
      emptyMessage="No Local Purchase Orders found"
      loadingMessage="Loading Local Purchase Orders..."
      enableRefresh={true}
      onRefresh={loadOrders}
      enableExport={true}
      exportFileName="LocalPurchaseOrders"
    />
  );
};
