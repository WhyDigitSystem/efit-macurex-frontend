...
const SECTIONS = [
  {
    items: [
      ...
      },
      {
        ...
        screenCode: "PURCHASE_CONTRACT_OPEN",
      },

      {
        name: "Purchase Delivery Schedule",
        icon: CalendarClock,
        path: "/purchasedeliveryschedule",
        screenCode: "PURCHASE_DELIVERY_SCHEDULE",
      },
      {
        name: "Purchase Bill",
        icon: Receipt,
      ...
      },
      {
        ...
        screenCode: "PURCHASE_ORDER_SHORT_CLOSE",
      },
      {
  ...
  {
    title: "Amendments",
    description: "Purchase amendments",
    icon: FileEdit,
    ...
    items: [
      {
        ...
        screenCode: "PURCHASE_ORDER_AMENDMENT",
      },
      {
        name: "Purchase Order Amendment Report",
        icon: FileText,
        path: "/purchaseorderamendmentreport",
        screenCode: "PURCHASE_ORDER_AMENDMENT_REPORT",
      },
      {
        name: "Purchase Contract Amendment",
        icon: FileSignature,
        path: "/purchasecontractamendment",
        screenCode: "PURCHASE_CONTRACT_AMENDMENT",
      },
      {
        name: "Purchase Contract Amendment Report",
        icon: ClipboardList,
        path: "/purchasecontractamendmentreport",
        screenCode: "PURCHASE_CONTRACT_AMENDMENT_REPORT",
      },
      {
        name: "Pending to Approval Amendment Report",
        icon: ListChecks,
        path: "/pendingtoapprovalamendmentreport",
        screenCode: "PENDING_TO_APPROVAL_AMENDMENT_REPORT",
      },
      {
        name: "PO Wise Shortage Qty",
        icon: Boxes,
        path: "/powiseshortageqty",
        screenCode: "PO_WISE_SHORTAGE_QTY",
      },
    ],
  },
];
      ...
      {hasAnyItems ? (
        <>
          ...
          <div className="flex items-center gap-2 mb-4">
            <div className="p-1.5 rounded-lg bg-gradient-to-br from-amber-500 to-amber-600 shadow-sm">
            ...
            <span className="text-xs text-gray-500 dark:text-gray-400 ml-2">
              Manage the entire purchase workflow, from enquiry to invoicing
            </span>
