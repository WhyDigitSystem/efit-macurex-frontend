...
const SECTIONS = [
  {
    items: [
      {
        name: "Scrap/Material Return/Rejection From S.C.",
        icon: RotateCcw,
        path: "/scrapmaterialreturn",
        screenCode: "SCRAP_MATERIAL_RETURN",
      },
      {
        name: "Supplier Rate Contract",
        icon: FileSignature,
        path: "/supplierratecontract",
        screenCode: "SUPPLIER_RATE_CONTRACT",
      },
      {
        name: "Job Order",
        icon: ClipboardList,
        path: "/joborder",
        screenCode: "JOB_ORDER",
      },
      {
        name: "Job Order Amendment",
        icon: FileEdit,
        path: "/joborderamendment",
        screenCode: "JOB_ORDER_AMENDMENT",
      },
      {
        name: "D.C For Sub Contracting (JO)",
        icon: Truck,
        path: "/dcforsubcontracting",
        screenCode: "DC_FOR_SUB_CONTRACTING",
      },
      {
        name: "S.C Bill",
        icon: Receipt,
      ...
      {
        name: "Sub Contract Supply Schedule",
        icon: CalendarClock,
        path: "/subcontractsupplyschedule",
        screenCode: "SUB_CONTRACT_SUPPLY_SCHEDULE",
      },
      {
        name: "Supplier Rate Contract Amendment",
        icon: FileEdit,
        path: "/supplierratecontractamendment",
        screenCode: "SUPPLIER_RATE_CONTRACT_AMENDMENT",
      },
      {
        name: "Sub Contract Re-Conciliation",
        icon: RefreshCcw,
        path: "/subcontractreconciliation",
        screenCode: "SUB_CONTRACT_RECONCILIATION",
      },
      {
        name: "ADV For Stores",
        icon: ShieldCheck,
        path: "/advforstores",
        screenCode: "ADV_FOR_STORES",
      },
      {
        name: "Job Order Short Close",
        icon: XCircle,
      ...
      },
      {
        ...
        screenCode: "DC_FOR_CAPITAL_ITEMS",
      },
    ],
  },
];
      ...
      {hasAnyItems ? (
        <>
          ...
          <div className="flex items-center gap-2 mb-4">
            <div className="p-1.5 rounded-lg bg-gradient-to-br from-violet-500 to-fuchsia-600 shadow-sm">
            ...
            <span className="text-xs text-gray-500 dark:text-gray-400 ml-2">
              Manage subcontracting, job orders, supplier contracts and billing
            </span>
