...
const SECTIONS = [
  {
    items: [
      {
        name: "Gate Inward Entry",
        icon: LogIn,
        path: "/gateinwardentry",
        screenCode: "GATE_INWARD_ENTRY",
      },
      {
        name: "Gate Outward Entry",
        icon: LogOut,
        path: "/gateoutwardentry",
        screenCode: "GATE_OUTWARD_ENTRY",
      },
    ],
  },
];
        ...
        <>
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xs text-gray-500 dark:text-gray-400 ml-2">
              Manage gate inward and outward entry records
            </span>
        ...
        <div className="flex items-center justify-center h-[50vh]">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              You do not have access to any security module.
            </p>
          </div>
        </div>
      )}
