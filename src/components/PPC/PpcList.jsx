...
const SECTIONS = [
  {
    items: [
      ...
      },
      {
        ...
        screenCode: "BOM_CORRECTION_REQUEST",
      },
      {
        name: "Drawing Attachments",
        icon: Paperclip,
        path: "/drawingattachments",
        screenCode: "DRAWING_ATTACHMENTS",
      },
    ],
  },
];
        ...
        <>
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xs text-gray-500 dark:text-gray-400 ml-2">
              Manage production planning, material planning and MRP operations
            </span>
