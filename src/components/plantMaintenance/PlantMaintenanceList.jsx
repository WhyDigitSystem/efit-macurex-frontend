...
const SECTIONS = [
  ...
  {
    title: "Transaction",
    description: "Manage maintenance activities, breakdowns and service requests",
    icon: ClipboardCheck,
    ...
    items: [
      {
        name: "Activities Carried Out",
        icon: ClipboardCheck,
        path: "/activitiescarriedout",
        screenCode: "ACTIVITIES_CARRIED_OUT",
      },
      {
        name: "Machine/Tool Breakdown",
        icon: Wrench,
        path: "/machinetoolbreakdown",
        screenCode: "MACHINE_TOOL_BREAKDOWN",
      },
      {
        name: "Machine/Tool Rectification",
        icon: Settings,
        path: "/machinetoolrectification",
        screenCode: "MACHINE_TOOL_RECTIFICATION",
      },
      {
        name: "Authorization For Breakdown",
        icon: ShieldCheck,
      ...
      // },
      {
        ...
        screenCode: "MACHINE_TOOLS_SCRAP_NOTE",
      },
      {
        name: "Maintenance Service Request",
        icon: LifeBuoy,
        path: "/maintenanceservicerequest",
        screenCode: "MAINTENANCE_SERVICE_REQUEST",
      },
    ],
  },
];
        ...
        <>
          ...
          {/* <div className="flex items-center gap-2 mb-5">
            ...
            <span className="text-xs text-gray-500 dark:text-gray-400 ml-2">
              Manage equipment maintenance, breakdowns, rectification, service
              requests and maintenance records
            </span>
