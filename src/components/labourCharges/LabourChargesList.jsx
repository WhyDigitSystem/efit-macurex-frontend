...
const SECTIONS = [
  {
    items: [
      {
        name: "LC Purchase Order",
        icon: ShoppingCart,
        path: "/lcpurchaseorder",
        screenCode: "LC_PURCHASE_ORDER",
      },
      {
        name: "Material Receipts - LC",
        icon: PackageCheck,
        path: "/materialreceiptslc",
        screenCode: "MATERIAL_RECEIPTS_LC",
      },
      {
        name: "LC Invoice - Tax Invoice",
        icon: Receipt,
        path: "/lcinvoicetaxinvoice",
        screenCode: "LC_INVOICE_TAX_INVOICE",
      },
      {
        name: "LC Delivery Schedule",
        icon: CalendarClock,
        path: "/lcdeliveryschedule",
        screenCode: "LC_DELIVERY_SCHEDULE",
      },
      {
        name: "LC Material Return",
        icon: RotateCcw,
        path: "/lcmaterialreturn",
        screenCode: "LC_MATERIAL_RETURN",
      },
      {
        name: "LC Purchase Order Short Close",
        icon: XCircle,
        path: "/lcpurchaseordershortclose",
        screenCode: "LC_PURCHASE_ORDER_SHORT_CLOSE",
      },
      {
        name: "LC Despatch Instruction",
        icon: Send,
        path: "/lcdespatchinstruction",
        screenCode: "LC_DESPATCH_INSTRUCTION",
      },
      {
        name: "LC Stock Statement",
        icon: ClipboardList,
        path: "/lcstockstatement",
        screenCode: "LC_STOCK_STATEMENT",
      },
    ],
  },
];
      ...
      {hasAnyItems ? (
        <>
          ...
          <div className="flex items-center gap-2 mb-4">
            <div className="p-1.5 rounded-lg bg-gradient-to-br from-orange-600 to-amber-500 shadow-sm">
            ...
            <span className="text-xs text-gray-500 dark:text-gray-400 ml-2">
              Manage labour charge purchase orders, material receipts, invoices,
              returns and stock statements
            </span>
